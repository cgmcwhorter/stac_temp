...
%The 5-number summary is the min, Q1, mean, Q3, and max. 

% Quiz 17
%Suppose $x$ comes from a normal distribution, $N(\mu, \sigma)$. Then the larger the value of $|z_x|$, the more `unusual' the value. 

%  If you take simple random samples of size 15 from a distribution with mean 130 and standard deviation 25, the resulting distribution of sample means is $N(130, 25/\sqrt{15}) \approx N(130, 6.45497)$. \pspace
