...
% Suppose that $f: A \to B$ and $g: B \to C$ are functions and that $g$ is injective. Then because the composition of injective functions is injective, if $g \circ f$ is injective, then $f$ is injective. 
