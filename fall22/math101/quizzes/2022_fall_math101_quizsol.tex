...
% The function $f(x)= 3 - (x + 6)^2$ is a quadratic function whose graph is a parabola opening upwards with vertex $(6, 3)$.

% Every equation of the form $ax^2 + bx + c= 0$ has a solution. 

% The polynomial $12x^2 + 29x - 8$ factors as $(4x - 1)(3x + 8)$.
