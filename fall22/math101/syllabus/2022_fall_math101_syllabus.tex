...
After this course, among other things, students should be able to\dots
	...
	\item Solve and apply linear equations.
	...
	\item Apply polynomials in `real world' problems.
