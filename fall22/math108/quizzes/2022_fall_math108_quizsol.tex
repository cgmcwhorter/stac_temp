...
%\textit{Any} linear function on \textit{any} bounded, nonempty region has a maximum and minimum. 



%The initial simplex tableau for a standard maximization problem is found below. This tableau implies that the original system had 3 inequalities and 5 variables. 
%	\begin{table}[!ht]
%	\centering
