...
An introductory course in algebra, intended to prepare students for calculus, precalculus, and higher-level studies in mathematics. Emphasis will be on solving problems symbolically, numerically, and graphically, as well as interpreting and analyzing solutions to understand the connections among these methods. {\itshape Students should enroll in this course only if they also intend to take one or more of Math 104, Math 109, or Math 201. Students who have earned a ``C'' or better in a math course for which degree credit is awarded may not register for or earn credit for Math 101. Reserved or restricted to: STEM Majors, Education Majors, and Finance Majors only, or by permission of instructor and Dean. Foundation Category: Quantitative Literacy}
\sectionbreak
...
After this course, among other things, students should be able to\dots
	...
	\item Perform basic algebraic operations with complex numbers.
	\item Understand and use scientific notation. 
	\item Convert between different units. 
	\item Compute lengths, areas, and volumes of various geometric objects. 
	\item Compute ratios, proportions, percentages, and rates, as well as apply in `real world' contexts. 
	\item Compute (weighted) averages and apply them, e.g. grades, GPAs, etc. 
	\item Understand the definition of functions and their inverses.
	\item Evaluate functions and perform basic function operations. 
	\item Understand and identify geometrical properties of functions, e.g. symmetries, maxima, etc. 
	...
	\item Solve linear equations and apply them to `real world' problems. 
	...
	\item Understand and apply polynomials to `real world' problems.
	\item Solve systems of linear equations and understand their applications. 
	\end{itemize}
...
The following is a \emph{tentative} schedule for the course and is subject to change. 
	...
	01/22 & Integers & 03/13 & Spring Break \\
	01/24 & Rationals & 03/18 & Linear Functions \\
	01/29 & Exponents & 03/20 & Linear Functions \\
	01/31 & Radicals & 03/25 & Linear Functions \\
	02/05 & Real \& Complex Numbers & 03/27 & Review \\
	02/07 & Percentages/Weighted Averages & 04/01 & Exam 2 \\
	02/12 & Scientific Notation \& Unit Conversions & 04/03 & Systems of Equations \\
	02/14 & Geometry & 04/08 & Quadratic Functions \\
	02/19 & Review & 04/10 & Quadratic Functions \\
	02/21 & Exam 1 & 04/15 & Polynomials \& Factorizations \\
	02/26 & Functions & 04/17 & Polynomials \& Factorizations \\
	02/28 & Functions & 04/22 & Polynomials \& Factorizations \\
	03/04 & Proportions/Rates & 04/24 & Review \\
	03/06 & Review & 04/29 &  Review \\
