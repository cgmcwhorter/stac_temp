...
% Problem 4
\problem{10} A ``$2^2$-face'' in a card game consists of having exactly 2 face cards and exactly 2 two's in one's five card hand. Being dealt five random cards from a standard 52 card deck, find the probability that one receives a ``$2^2$-face.'' 
