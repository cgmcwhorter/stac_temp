...
The following is a \emph{tentative} schedule for the course and is subject to change. Note that the dates for Section~B are shifted one day later than the listed dates. 
        \begin{table}[!ht]
        \centering
        \scalebox{0.78}{%
        \begin{tabular}{ll || ll}
