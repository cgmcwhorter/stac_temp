...
Preparation for calculus. Curve tracing; algebraic, trigonometric, exponential, and logarithmic functions and their inverses; elements of analytic geometry. (Not open to students who have completed MATH~201 or equivalent.) {\itshape Foundation Category: Quantitative Literacy}
\sectionbreak
...
{\itshape\bfseries\color{stacred}Textbook.} The textbook for the course is \textit{Preparation for Calculus: Functions and How They Change} by Bruce Crauder, Benny Evans, and Alan Noell. While you may purchase a physical copy of the textbook or an ebook version of the text, the intention that you will access the textbook as an ebook via the course online homework system for free, c.f. the homework section of the syllabus. Create an account at \href{https://store.macmillanlearning.com/us/login}{https://store.macmillanlearning.com/us/login} and use course code \texttt{y487tf} to access the course. The course may also make use of other additional text resources provided by the instructor. \pspace
...
There are two homework components: written homework and online homework. \pspace

{\itshape\bfseries\color{stacred}Written Homework.} Written homework will occur less often than online homework. The purpose of these homeworks is to give feedback on written solutions. Therefore, these will focus on the most important, difficult, or confusing course topics. In addition, these homeworks will often be shorter. Because of these two factors, students should put special effort into producing their best work---including full solutions with written explanations and all necessary work shown. Students should treat these homework problems as if they were exam problems. This way, you will receive feedback on how you would perform on similar problems during an exam. Be sure to start these homeworks early and as your instructor for help if you are experience difficulties! Extensions on these homeworks may be possible. However, requests for extensions should be made at least 24-hours in advance, if at all possible. Any extensions, due dates, and grade penalties for late assignments will be determined by the instructor on a student-by-student basis. \pspace

{\itshape\bfseries\color{stacred}Online Homework.} The majority of course homework will be done using an online homework system through the Macmillan `Achieve' learning system. This will allow students to receive immediate feedback on their mastery of course material. Furthermore, this will allow students to practice more problems that could otherwise be assigned during a traditional course. Though these assignments will often require no work to be shown, students are highly encouraged to take notes on these problems and write-up full solutions from which they can later study. Be sure to regularly check the Achieve system---at least daily---to be sure that you are keeping up with assignments. Moreover, start assignments early so that if you experience difficulty with the content, understanding the question, or submitting your answers that these can be addressed with the instructor well before the due date. Extensions on these homeworks may be possible. However, requests for extensions should be made at least 24-hours in advance, if at all possible. Any extensions, due dates, and grade penalties for late assignments will be determined by the instructor on a student-by-student basis. \pspace 

You will enroll in the course using the Macmillan website. First, create an account (if you do not already have one) using the following link: \href{https://store.macmillanlearning.com/us/login}{https://store.macmillanlearning.com/us/login}. You then add the course using the following course code: \texttt{y487tf}. You will need to pay to access this online homework system. However, there is a two-week grace period for payments. Meaning, you have two-weeks to submit payment. If you allow this period to lapse, you will lose access to the system; however, your profile, homeworks, and grades will persist. When you submit your payment, you will regain access to these with no information lost. The Achieve system will allow you to access not only the assignments, additional materials, but a digital copy of the textbook. You are not required to purchase a physical copy of the textbook. However, students who wish to purchase a physical copy may certainly do so. \pspace

Purchasing this online system will give the students access to this account (with instructor permissions properly set) for the next four years. Students can return to course assignments and materials via Achieve in future courses to review or practice more if they have difficulties in future courses. If a student has to re-take the course within the next four years and the Achieve system with the same textbook is used, the professor was also told that students should be able to email Macmillan to re-gain access to the system without additional payment. \pspace
