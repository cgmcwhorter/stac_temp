...
% Problem 1
\problem{10} Find the vertex form of the quadratic function $y= x^2 + 6x + 4$.
...
% Problem 2
\problem{10} Find the vertex form of the quadratic function $y= x^2 + 6x - 7$.
...
% Problem 3
\problem{10} Find the vertex form of the quadratic function $y= 4x^2 - 4x + 7$.
