...
%Let $f(x)= ax^2 + bx + c$ be a quadratic function. There will only be a distinct solution to the equation $f(x)= 0$ if the discriminant of $f(x)$ is zero. 


% For any polynomial $ax^2 + bx + c$, there exists a factorization $(x - r_1)(x - r_2)$, where $r_1, r_2$ are rational numbers.
