...
$f^{-1}(A) \cup f^{-1}(B) \subseteq f^{-1}(A \cup B)$: Suppose that \ansun{0.72cm}{$x \in f^{-1}(A) \cup f^{-1}(B)$}. This implies \pspace that $x \in f^{-1}(A)$ or $f^{-1}(B)$. \pspace
	...
	\hspace{1cm} Case 2, $x \in f^{-1}(B)$: If $x \in f^{-1}(B)$, then $f(x) \in$ \ansun{1.32cm}{$B$}. But then $f(x) \in f(A \cup B)$. \pspace \hspace{1cm} This shows that $x \in$ \ansun{0.97cm}{$A \cup B$}. \pvspace{2\baselineskip}
