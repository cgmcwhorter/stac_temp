...
\textit{Proof.} To prove that $A \cap (B - C)= (A \cap B) - (A \cap C)$, we need to show \blank{3cm} and \pspace \blank{3cm}. \pvspace{2\baselineskip}
