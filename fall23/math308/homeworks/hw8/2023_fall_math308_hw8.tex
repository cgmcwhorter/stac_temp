...
% Problem 1
\problem{10} Let $A= \{ 2, 6, 8, 10 \}$, $B$ be the set of nonnegative numbers less than 10, and $C$ be the set of perfect squares less than 10. Define $f: A \to \mathbb{Z}$ and $g: B \setminus C$ via $x \to \frac{15(x + 8)}{x}$ and $x \mapsto \frac{5(x^2 - 16x + 88)}{4}$, respectfully. Fully justifying your answer, determine whether $f \equiv g$. 
