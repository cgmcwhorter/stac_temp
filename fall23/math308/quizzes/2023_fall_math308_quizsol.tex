...
%The relation $\mathbb{Z}$ given by $x \sim y$ if and only if $x < y$ is an equivalence relation. 
%Let $a, b \in \mathbb{Z}$ with $a \neq 0$. Then $a \mid b$ if and only if expressing $\frac{b}{a}$ with the division algorithm is given by $b= qa$. 

%The hex number 51e0 in base-10 is $\text{51e0}= 0 \cdot 16^0 + 13 \cdot 16^1 + 1 \cdot 16^2 + 5 \cdot 16^3= 20944$.



%$16^{20232024} \equiv 1 \mod 17$

%The number ways of lining up three people from a total of eight people is $_8P_3= 8 \cdot7 \cdot 6= 336$. 


%The number of ways of selecting 3 movies to watch from a choice of five genres is $\binom{8}{3}$.


%If there are 14 weeks in a semester and 16 homework assignments, there must be a week where at least two homeworks were due.
